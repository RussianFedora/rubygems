...
%doc History.txt
%doc MIT.txt LICENSE.txt Manifest.txt
%dir %{gem_dir}
%dir %{gem_home}
%dir %{gem_home}/cache
%dir %{gem_home}/gems
...
%changelog
* Tue Sep 18 2012 Sergey Mihailov <sergey.mihailov@gmail.com> - 1.8.24-1
- Update to 1.8.24, dropping rubygems-1.3.7-noarch-gemdir patch
