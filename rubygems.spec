...
# on 2011-10-01)
#_mx Patch6:		rubygems-1.8.5-all-load-paths.patch
...
%changelog
* Thu Jun 13 2013 Sergey Mihailov <sergey.mihailov@gmail.com> - 1.8.25-1
- Update to 1.8.25
- drop patch rubygems-1.8.5-all-load-paths.patch.

* Fri Nov 02 2012 Miroslav Suchý <msuchy@redhat.com> 1.8.16-2
- disable tests (msuchy@redhat.com)

* Mon Jul 02 2012 Miroslav Suchý <msuchy@redhat.com> 1.8.16-1
